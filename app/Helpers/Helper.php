...
class Helper
{
  ...
  public static function base64_img($url)
  {

    // Get the file extension
    $extension = pathinfo($url, PATHINFO_EXTENSION);

    // Map the file extension to the corresponding image type
    $imageTypes = [
      'jpg' => 'jpeg',
      'jpeg' => 'jpeg',
      'png' => 'png',
    ...
    // Use the mapped image type or default to 'jpeg'
    $imageType = isset($imageTypes[$extension]) ? $imageTypes[$extension] : 'jpeg';
    // Construct the base64 image string
    $base64_image = 'data:image/' . $imageType . ';base64,' . base64_encode(file_get_contents($url));
    return $base64_image;
  }
}
